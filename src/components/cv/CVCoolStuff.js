    ...
    <CVItem>
      ...
      <ItemDesc>
        ...
        <p>
          ...
          this prototype any further, but plan to integrate some of the ideas
          into a future project. Check out the code on{' '}
        ...
        <p>
          ...
          physics engine that relied on mutating objects (<Em>Matter.js</Em>)
          was an interesting challenge. In the end, I kept all the important
          data in <Em>Redux</Em>, synchronising it with the physics engine when
          the store updated.
        </p>
        <p>
