  ...
  <CVSection>
    ...
    <CVItem>
      ...
      <ItemDesc>
        ...
        <p>
          ...
          app, and writing a UI with <Em>React</Em>, <Em>Redux</Em>,{' '}
          <Em>Relay</Em>, and <Em>Immutable.js</Em>.
        </p>
        <p>
          I also architected the light-weight <Em>React/Redux</Em> shop
          front-end used on all Music Glue stores. Keeping within our
          performance budget here was an interesting challenge, but the result
    ...
    <CVItem>
      ...
      <ItemDesc>
        ...
        <p>
          As co-founder &amp; CTO, I was responsible for all the technical work
          on our product Erase All Kittens, a web-based game that teaches
        ...
        <p>
          ...
          <Em>React.js</Em>, and the <Em>WebAudio API</Em>. I wrote a backend
          API in <Em>Node.JS</Em>, using <Em>PostgreSQL</Em>, <Em>MongoDB</Em>,
          and <Em>Stripe</Em>.
        </p>
        <p>
